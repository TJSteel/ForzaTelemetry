 ...
 */
package com.tjsteel.forzaTelemetry.forza;
...
import com.tjsteel.forzaTelemetry.utility.FilePrinter;
...
public class Player {
	...
	public void printValues()  {
		...
		FilePrinter filePrinter = this.getFilePrinter();
		if (filePrinter != null && !filePrinter.isFileOpen()) {
			this.printStart();	
		}
		StringBuilder sb = new StringBuilder();
		...
		if (filePrinter != null) filePrinter.writeToFile(sb.toString());
	}    
    // }} Print functions
