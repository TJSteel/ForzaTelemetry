 ...
 */
package com.tjsteel.forzaTelemetry.gauges;
...
public class GaugeRpm extends JPanel {
    ...
    public GaugeRpm() {
    	try {
        	setBiGauge(ImageIO.read(getClass().getClassLoader().getResource("com/tjsteel/forzaTelemetry/images/RpmGauge.png")));
        	setBiRedline(ImageIO.read(getClass().getClassLoader().getResource("com/tjsteel/forzaTelemetry/images/RpmNeedle.png")));
        	setBiNeedle(ImageIO.read(getClass().getClassLoader().getResource("com/tjsteel/forzaTelemetry/images/RpmNeedle.png")));
    	} catch (IOException e) {
    		e.printStackTrace();
    	}
